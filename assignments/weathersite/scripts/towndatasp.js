...
tData.onload = function () {
    ...
    document.getElementById('events1').innerHTML = gvWeather.towns["3"].events["0"];
    document.getElementById('events2').innerHTML = gvWeather.towns["3"].events[1];
    document.getElementById('events3').innerHTML = gvWeather.towns["3"].events[2];
}
